...
import { ShieldCheck, ShoppingCart, LayoutDashboard, Package, CheckCircle, Star } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a className="text-sm text-gray-300 hover:text-white" href="#clients">For Clients</a>
              <a className="text-sm text-gray-300 hover:text-white" href="#suppliers">For Suppliers</a>
              <a className="text-sm text-gray-300 hover:text-white" href="#how-it-works">Pricing</a>
            </div>

            <div className="flex flex-col gap-4">
              <h4 className="font-bold text-white">Company</h4>
              <a className="text-sm text-gray-300 hover:text-white" href="#testimonials">About Us</a>
              <a className="text-sm text-gray-300 hover:text-white" href="#testimonials">Careers</a>
              <a className="text-sm text-gray-300 hover:text-white" href="#testimonials">Contact</a>
            </div>
          ...
          <div className="mt-12 border-t border-gray-100/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-300">
            <p>&copy; {new Date().getFullYear()} mwrd. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
